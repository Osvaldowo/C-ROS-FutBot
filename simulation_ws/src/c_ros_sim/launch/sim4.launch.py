...
def generate_launch_description():
    ...
    # CONFIGURACIÓN DE LOS ROBOTS (2 vs 2)
    # Equipo A (1 y 2) mira hacia 0 rads. Equipo B (3 y 4) mira hacia Pi rads.
    robots = [
        {'name': 'futbot_1', 'x': '-0.6', 'y': '0.3', 'Y': '0.0'},
        {'name': 'futbot_2', 'x': '-0.6', 'y': '-0.3', 'Y': '0.0'},
        {'name': 'futbot_3', 'x': '0.6',  'y': '-0.3', 'Y': '3.14159'},
        {'name': 'futbot_4', 'x': '0.6',  'y': '0.3', 'Y': '3.14159'}
    ]
